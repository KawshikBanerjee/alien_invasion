...
class Scoreboard:
    def __init__(self, ai_game):
        ...
        self.text_color = (243,198,35)
        self.font = pygame.font.Font("fonts/Gilroy-Light.otf", 30)
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(("Max: "+high_score_str), True, self.text_color, self.settings.bg_color)
